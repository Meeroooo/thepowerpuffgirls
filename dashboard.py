                    ...
                    with st.spinner("Generating explanation..."):
                        if org_info is not None and not org_info.empty:
                            org_profile = {
                                ...
                                "Region": str(org_info.get("Region", "—")) if pd.notna(org_info.get("Region")) else "—",
                                "Size": str(org_info.get("Size", "—")) if pd.notna(org_info.get("Size")) else "—",
                                "Maturity": str(org_info.get("Maturity", "—")) if pd.notna(org_info.get("Maturity")) else "—",
                                "Threats": str(org_info.get("Threats", "—")) if pd.notna(org_info.get("Threats")) else "—"
                            }
                        else:
                            org_profile = {
                                "Industry": "—", "Region": "—", 
                                "Size": "—", "Maturity": "—", "Threats": "—"
                            }
